...
export async function POST(request: Request) {
  try {
    ...
    if (!process.env.GOOGLE_CLIENT_EMAIL || !process.env.GOOGLE_PRIVATE_KEY || !process.env.GOOGLE_SHEET_ID_HOLIDAY) {
    ...
    const spreadsheetId = process.env.GOOGLE_SHEET_ID_HOLIDAY;
    ...
    console.error('Error submitting holiday answer:', error);
